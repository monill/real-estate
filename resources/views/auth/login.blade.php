        ...
        <div class="login-box">
            <div class="white-box">
                ...
                <div class="form-group ">
                    <div class="col-xs-12">
                        <input class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" type="email" value="{{ old('email') }}" name="email" required placeholder="E-mail" autocomplete="off">
                        @if ($errors->has('email'))
                ...
                <div class="form-group">
                    <div class="col-xs-12">
                        <input class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" type="password" name="password" required placeholder="Senha" autocomplete="off">
                ...
                <div class="form-group">
                    <div class="col-md-12">
                        <div class="checkbox checkbox-primary pull-left p-t-0">
                            ...
                            <label for="checkbox-signup" name="remember" {{ old('remember') ? 'checked' : '' }}> Lembrar me </label>
                        </div>
                ...
                <div class="form-group m-b-0">
                    <div class="col-sm-12 text-center">
                        <p>Área Restrita - Clique<a href="{{ url('/') }}" class="text-primary m-l-5"><b>aqui</b></a> para voltar à Home</p>
                    </div>
                </div>
                {!! Form::close() !!}
                ...
                <div class="form-group ">
                    <div class="col-xs-12">
                        <input class="form-control" type="email" name="email" required autocomplete="off" placeholder="E-mail">
                        @if ($errors->has('email'))
