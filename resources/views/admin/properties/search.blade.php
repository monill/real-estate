        ...
        @foreach($properties as $property)
            <div class="col-sm-6 col-md-3 col-lg-3">
                <div class="white-box pro-box p-0">
                    <div class="pro-list-img" style="background: url('{{ propertyMainImage($property->id) }}') center center / cover no-repeat;">
                    ...
                    <hr class="m-0"> <span class="label pro-col-label label-white text-dark">{{ $property->purpose == 1 ? 'Locação' : 'Venda' }}</span>
