        ...
        <div class="container-big section-content bg-logo">
            <div class="container clearfix">
                <div class="big-notice onscroll-animate">
                    <h3><span class="text-uppercase"><strong>{{ $settings->site_title }}</strong></span> colocar um texto legal aqui</h3>
                    <div class="onscroll-animate pull-right" data-delay="700" data-animation="flipInY">
                        <div class="button-container"><a class="button" href="{{ url('contato') }}">Contate-nos</a></div>
                    </div>
                </div>
            </div>
        </div>
